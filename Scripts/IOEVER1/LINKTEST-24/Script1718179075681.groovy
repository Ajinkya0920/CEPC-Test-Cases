...
WebUI.callTestCase(findTestCase('Groundwork/Go into Main Project'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Catalogue View - Enterprise Product Catalogue/a_Template_glyphicon glyphicon-save pull-ri_22653d'))
